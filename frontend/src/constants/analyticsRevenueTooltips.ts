...
export const TOOLTIP_OPERATIONAL_REVENUE =
  'Выручка — сумма строк закрытых сделок (line_total или количество × цена). ' +
  'Включает все строки сделки, в том числе отгрузку со склада клиента. Отменённые и незакрытые сделки не входят. ' +
  'Для сделок-сессий — все не отменённые. ' +
