...
export const dealsApi = {
   ...
   * from/to — ISO-границы по дате сделки. */
  financeQueue: (params?: { from?: string; to?: string }) =>
    client.get<(Deal & { clientDebt: number; missingContract?: boolean })[]>('/deals/finance-queue', { params }).then((r) => r.data),
