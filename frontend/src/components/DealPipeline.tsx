...
const statusToStep: Partial<Record<DealStatus, DealStatus>> = {
  ...
  PENDING_ADMIN: 'WAITING_WAREHOUSE_MANAGER',
  ADMIN_APPROVED: 'WAITING_WAREHOUSE_MANAGER',
  READY_FOR_LOADING: 'WAITING_WAREHOUSE_MANAGER',
  LOADING_ASSIGNED: 'WAITING_WAREHOUSE_MANAGER',
  READY_FOR_DELIVERY: 'WAITING_WAREHOUSE_MANAGER',
  IN_DELIVERY: 'WAITING_WAREHOUSE_MANAGER',
  READY_FOR_SHIPMENT: 'WAITING_WAREHOUSE_MANAGER',
  SHIPMENT_ON_HOLD: 'WAITING_WAREHOUSE_MANAGER',
};
