...
import { Tabs, Card, Col, Row, Statistic, Table, Typography, Spin, Tag, Segmented, theme, Tooltip, Badge, List, Checkbox, Empty, Button, Select, Space, DatePicker, message } from 'antd';
import {
  DollarOutlined,
  RiseOutlined,
  PercentageOutlined,
    ...
    <div>
      ...
      <Tabs
        ...
        items={[
          ...
          { key: 'cohorts', label: 'Когорты', children: cohortsTab },
