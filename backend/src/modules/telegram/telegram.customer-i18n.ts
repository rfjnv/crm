...
const STRINGS: Record<Lang, Record<string, string>> = {
  ru: {
    ...
    'orders.empty': 'По номеру {phone} пока нет заказов.',
    ...
    'review.noOrdersBody': 'По номеру {phone} пока нет заказов.',
    ...
    'review.saveFailed': 'Не удалось сохранить отзыв. Попробуйте позже или обратитесь к менеджеру.',
  ...
  uz: {
    ...
    'orders.empty': "{phone} raqami bo'yicha hali buyurtmalar yo'q.",
    ...
    'review.noOrdersBody': "{phone} raqami bo'yicha hali buyurtmalar yo'q.",
    ...
    'review.saveFailed': "Fikrni saqlab bo'lmadi. Birozdan so'ng urinib ko'ring yoki menejerga murojaat qiling.",
