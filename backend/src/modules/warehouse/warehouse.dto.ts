...
export const updateProductDto = z.object({
  ...
  purchasePrice: z.preprocess((v) => (v === '' || v === null ? null : Number(v)), z.number().min(0).nullable().optional()),
  salePrice: z.preprocess((v) => (v === '' || v === null ? null : Number(v)), z.number().min(0).nullable().optional()),
  installmentPrice: z.preprocess((v) => (v === '' || v === null ? null : Number(v)), z.number().min(0).nullable().optional()),
