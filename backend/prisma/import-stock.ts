 ...
 * Data source: "остаток 02.xlsx" (inventory balance as of 02.02.2026).
 *
 * All 219 products are hardcoded below so the script can run
 * on production (Render) without needing the Excel file.
 *
 * Behavior:
 *   - If a product with the given SKU already exists => SKIP (preserves existing stock).
...
const PRODUCTS: StockProduct[] = [
  ...
  { name: 'Самоклеющаяся бумага Ф:70*100 белая (Китай)', sku: 'SK-CN-70x100', unit: 'лист', format: '70*100', category: 'Самоклеющаяся бумага', countryOfOrigin: 'Китай', stock: 153030 },
  { name: 'Самоклеющаяся бумага Ф:50*70 белая (Китай)', sku: 'SK-CN-50x70', unit: 'лист', format: '50*70', category: 'Самоклеющаяся бумага', countryOfOrigin: 'Китай', stock: 355250 },
  { name: 'Самоклеющаяся бумага Ф:70*100 белая б/н (Китай)', sku: 'SK-CN-70x100-BN', unit: 'лист', format: '70*100 б/н', category: 'Самоклеющаяся бумага', countryOfOrigin: 'Китай', stock: 83600 },
  { name: 'Самоклеющаяся бумага Ф:50*70 белая б/н (Китай)', sku: 'SK-CN-50x70-BN', unit: 'лист', format: '50*70 б/н', category: 'Самоклеющаяся бумага', countryOfOrigin: 'Китай', stock: 208000 },
  { name: 'Самоклеющаяся бумага Ф:50*35 белая (Китай)', sku: 'SK-CN-50x35', unit: 'лист', format: '50*35', category: 'Самоклеющаяся бумага', countryOfOrigin: 'Китай', stock: 272200 },
  ...
  { name: 'Самоклеющаяся бумага Ф:70*100 красная (Китай)', sku: 'SK-CN-RED-70x100', unit: 'лист', format: '70*100', category: 'Самоклеющаяся бумага', countryOfOrigin: 'Китай', stock: 1155 },
  { name: 'Самоклеющаяся бумага Ф:50*70 красная (Китай)', sku: 'SK-CN-RED-50x70', unit: 'лист', format: '50*70', category: 'Самоклеющаяся бумага', countryOfOrigin: 'Китай', stock: 7100 },
  ...
  { name: 'Самоклеющаяся бумага Ф:70*100 (Турция)', sku: 'SK-TR-70x100', unit: 'лист', format: '70*100', category: 'Самоклеющаяся бумага', countryOfOrigin: 'Турция', stock: 25600 },
  { name: 'Самоклеющаяся бумага Ф:50*70 (Турция)', sku: 'SK-TR-50x70', unit: 'лист', format: '50*70', category: 'Самоклеющаяся бумага', countryOfOrigin: 'Турция', stock: 68097 },
  ...
  { name: 'Мелованная бумага 170гр/м2 70*100', sku: 'MEL-HK-170-70x100', unit: 'лист', format: '170гр (70*100)', category: 'Мелованная бумага', countryOfOrigin: null, stock: 9500 },
  { name: 'Мелованная бумага 105гр/м2 70*100 МАТТ', sku: 'MEL-HK-105-MATT', unit: 'лист', format: '105гр (70*100) матт', category: 'Мелованная бумага', countryOfOrigin: null, stock: 25750 },

  // ==================== ФОЛЬГА ДЛЯ ТИСНЕНИЯ (золото / серебро) ====================
  { name: 'Фольга для тиснения 64см*120м золото', sku: 'FOIL-GOLD-120', unit: 'рул', format: 'золото', category: 'Фольга для тиснения', countryOfOrigin: null, stock: 726 },
  { name: 'Фольга для тиснения 64см*240м золото', sku: 'FOIL-GOLD-240', unit: 'рул', format: 'золото', category: 'Фольга для тиснения', countryOfOrigin: null, stock: 380 },
  ...
  { name: 'Фольга для тиснения 64см*120м серебро', sku: 'FOIL-SILVER-120', unit: 'рул', format: 'серебро', category: 'Фольга для тиснения', countryOfOrigin: null, stock: 1297 },
  { name: 'Фольга для тиснения 64см*240м серебро', sku: 'FOIL-SILVER-240', unit: 'рул', format: 'серебро', category: 'Фольга для тиснения', countryOfOrigin: null, stock: 586 },
  ...
  { name: 'Фольга для тиснения 64см*120м золото (сарик)', sku: 'FOIL-GOLD-Y-120', unit: 'рул', format: 'золото (сарик)', category: 'Фольга для тиснения', countryOfOrigin: null, stock: 1987 },
  { name: 'Фольга для тиснения 64см*240м золото (сарик)', sku: 'FOIL-GOLD-Y-240', unit: 'рул', format: 'золото (сарик)', category: 'Фольга для тиснения', countryOfOrigin: null, stock: 600 },
  ...
  // ==================== ФОЛЬГА (цветная) ====================
  { name: 'Фольга для тиснения цветная 64см*120м зелёная', sku: 'FOIL-GREEN-120', unit: 'рул', format: 'яшил', category: 'Фольга для тиснения', countryOfOrigin: null, stock: 30 },
  { name: 'Фольга для тиснения переливающаяся 64см*120м серебро', sku: 'FOIL-HOLO-120', unit: 'рул', format: 'переливающий сер', category: 'Фольга для тиснения', countryOfOrigin: null, stock: 161 },
  ...
  { name: 'Фольга для тиснения цветная 64см*120м чёрная', sku: 'FOIL-BLACK-120', unit: 'рул', format: 'кора', category: 'Фольга для тиснения', countryOfOrigin: null, stock: 87 },
  { name: 'Фольга для тиснения цветная 64см*120м красная', sku: 'FOIL-RED-120', unit: 'рул', format: 'кизил', category: 'Фольга для тиснения', countryOfOrigin: null, stock: 217 },
  { name: 'Фольга для тиснения цветная 64см*120м синяя', sku: 'FOIL-BLUE-120', unit: 'рул', format: 'оч кук', category: 'Фольга для тиснения', countryOfOrigin: null, stock: 55 },
  ...
  { name: 'Фольга для тиснения цветная 64см*120м жемчужная', sku: 'FOIL-PEARL-120', unit: 'рул', format: 'жемчук', category: 'Фольга для тиснения', countryOfOrigin: null, stock: 100 },
  ...
  { name: 'Полигр. бесцв. краска PI-125', sku: 'UV-PI125', unit: 'кг', format: 'PI 125', category: 'UV лак', countryOfOrigin: 'Турция', stock: 1375 },
  ...
  { name: 'Полигр. бесцв. краска PI-250', sku: 'UV-PI250', unit: 'кг', format: 'PI 250', category: 'UV лак', countryOfOrigin: 'Турция', stock: 3675 },
  ...
  { name: 'Полигр. бесцв. краска PI-400А', sku: 'UV-PI400A', unit: 'кг', format: 'PI 400А', category: 'UV лак', countryOfOrigin: 'Турция', stock: 3475 },
  ...
  { name: 'Полигр. бесцв. краска PI-500 (emboss)', sku: 'UV-PI500', unit: 'кг', format: 'emboss', category: 'UV лак', countryOfOrigin: 'Турция', stock: 210 },

  // ==================== ЛАМИНАЦИОННАЯ ПЛЕНКА (ГЛЯНЦЕВАЯ) ====================
  { name: 'Ламинационная пленка ф:3000м глянцевая 84см', sku: 'LAM-GL-84', unit: 'рул', format: '84', category: 'Ламинационная пленка', countryOfOrigin: null, stock: 57 },
  ...
  { name: 'Ламинационная пленка ф:3000м глянцевая 70см', sku: 'LAM-GL-70', unit: 'рул', format: '70', category: 'Ламинационная пленка', countryOfOrigin: null, stock: 11 },
  { name: 'Ламинационная пленка ф:3000м глянцевая 68см', sku: 'LAM-GL-68', unit: 'рул', format: '68', category: 'Ламинационная пленка', countryOfOrigin: null, stock: 22 },
  { name: 'Ламинационная пленка ф:3000м глянцевая 65см', sku: 'LAM-GL-65', unit: 'рул', format: '65', category: 'Ламинационная пленка', countryOfOrigin: null, stock: 40 },
  ...
  { name: 'Ламинационная пленка ф:3000м глянцевая 60см', sku: 'LAM-GL-60', unit: 'рул', format: '60', category: 'Ламинационная пленка', countryOfOrigin: null, stock: 47 },
  { name: 'Ламинационная пленка ф:3000м глянцевая 58см', sku: 'LAM-GL-58', unit: 'рул', format: '58', category: 'Ламинационная пленка', countryOfOrigin: null, stock: 61 },
  { name: 'Ламинационная пленка ф:3000м глянцевая 55см', sku: 'LAM-GL-55', unit: 'рул', format: '55', category: 'Ламинационная пленка', countryOfOrigin: null, stock: 45 },
  { name: 'Ламинационная пленка ф:3000м глянцевая 50см', sku: 'LAM-GL-50', unit: 'рул', format: '50', category: 'Ламинационная пленка', countryOfOrigin: null, stock: 92 },
  { name: 'Ламинационная пленка ф:3000м глянцевая 48см', sku: 'LAM-GL-48', unit: 'рул', format: '48', category: 'Ламинационная пленка', countryOfOrigin: null, stock: 68 },
  { name: 'Ламинационная пленка ф:3000м глянцевая 42см', sku: 'LAM-GL-42', unit: 'рул', format: '42', category: 'Ламинационная пленка', countryOfOrigin: null, stock: 7 },
  { name: 'Ламинационная пленка ф:3000м глянцевая 35см', sku: 'LAM-GL-35', unit: 'рул', format: '35', category: 'Ламинационная пленка', countryOfOrigin: null, stock: 5 },
  { name: 'Ламинационная пленка ф:3000м глянцевая 30см', sku: 'LAM-GL-30', unit: 'рул', format: '30', category: 'Ламинационная пленка', countryOfOrigin: null, stock: 7 },
  ...
  { name: 'Ламинационная пленка ф:3000м матовая 70см', sku: 'LAM-MT-70', unit: 'рул', format: '70мат', category: 'Ламинационная пленка', countryOfOrigin: null, stock: 0 },
  { name: 'Ламинационная пленка ф:3000м матовая 72см', sku: 'LAM-MT-72', unit: 'рул', format: '72мат', category: 'Ламинационная пленка', countryOfOrigin: null, stock: 26 },
  { name: 'Ламинационная пленка ф:3000м матовая 68см', sku: 'LAM-MT-68', unit: 'рул', format: '68мат', category: 'Ламинационная пленка', countryOfOrigin: null, stock: 34 },
  { name: 'Ламинационная пленка ф:3000м матовая 62см', sku: 'LAM-MT-62', unit: 'рул', format: '62мат', category: 'Ламинационная пленка', countryOfOrigin: null, stock: 59 },
  { name: 'Ламинационная пленка ф:3000м матовая 60см', sku: 'LAM-MT-60', unit: 'рул', format: '60мат', category: 'Ламинационная пленка', countryOfOrigin: null, stock: 73 },
  { name: 'Ламинационная пленка ф:3000м матовая 58см', sku: 'LAM-MT-58', unit: 'рул', format: '58мат', category: 'Ламинационная пленка', countryOfOrigin: null, stock: 41 },
  { name: 'Ламинационная пленка ф:3000м матовая 50см', sku: 'LAM-MT-50', unit: 'рул', format: '50мат', category: 'Ламинационная пленка', countryOfOrigin: null, stock: 37 },
  { name: 'Ламинационная пленка ф:3000м матовая 42см', sku: 'LAM-MT-42', unit: 'рул', format: '42мат', category: 'Ламинационная пленка', countryOfOrigin: null, stock: 10 },
  { name: 'Ламинационная пленка ф:3000м матовая 35см', sku: 'LAM-MT-35', unit: 'рул', format: '35мат', category: 'Ламинационная пленка', countryOfOrigin: null, stock: 2 },
  { name: 'Ламинационная пленка ф:3000м матовая 30см', sku: 'LAM-MT-30', unit: 'рул', format: '30мат', category: 'Ламинационная пленка', countryOfOrigin: null, stock: 0 },
  ...
  { name: 'Ламинационная пленка металлическая ф:3000м золото 62см', sku: 'LAM-GOLD-62', unit: 'рул', format: '62 Gold', category: 'Ламинационная пленка', countryOfOrigin: null, stock: 13 },
  ...
  { name: 'Ламинационная пленка металлическая ф:3000м серебро 60см', sku: 'LAM-SILVER-60', unit: 'рул', format: '60 Silver', category: 'Ламинационная пленка', countryOfOrigin: null, stock: 8 },
  { name: 'Ламинационная пленка металлическая ф:3000м серебро 50см', sku: 'LAM-SILVER-50', unit: 'рул', format: '50 Silver', category: 'Ламинационная пленка', countryOfOrigin: null, stock: 8 },
  ...
  { name: 'Офсетная пластина UV СТР 1030*790', sku: 'PLATE-UV-1030x790', unit: 'шт', format: '1030*790', category: 'Офсетные пластины', countryOfOrigin: null, stock: 9000 },
  ...
  { name: 'Офсетная пластина UV СТР 890*576', sku: 'PLATE-UV-890x576', unit: 'шт', format: '890*576', category: 'Офсетные пластины', countryOfOrigin: null, stock: 5000 },
  { name: 'Офсетная пластина UV СТР 860*580', sku: 'PLATE-UV-860x580', unit: 'шт', format: '860*580', category: 'Офсетные пластины', countryOfOrigin: null, stock: 1000 },
  ...
  { name: 'Офсетная пластина UV СТР 775*635', sku: 'PLATE-UV-775x635', unit: 'шт', format: '775*635', category: 'Офсетные пластины', countryOfOrigin: null, stock: 6000 },
  { name: 'Офсетная пластина UV СТР 775*605', sku: 'PLATE-UV-775x605', unit: 'шт', format: '775*605', category: 'Офсетные пластины', countryOfOrigin: null, stock: 4000 },
  { name: 'Офсетная пластина UV СТР 745*615', sku: 'PLATE-UV-745x615', unit: 'шт', format: '745*615', category: 'Офсетные пластины', countryOfOrigin: null, stock: 1000 },
  { name: 'Офсетная пластина UV СТР 745*605', sku: 'PLATE-UV-745x605', unit: 'шт', format: '745*605', category: 'Офсетные пластины', countryOfOrigin: null, stock: 9000 },
  ...
  { name: 'Офсетная пластина UV СТР 525*459', sku: 'PLATE-UV-525x459', unit: 'шт', format: '525*459', category: 'Офсетные пластины', countryOfOrigin: null, stock: 10000 },
  { name: 'Офсетная пластина UV СТР 510*400 (0,15)', sku: 'PLATE-UV-510x400-015', unit: 'шт', format: '510*400(0,15)', category: 'Офсетные пластины', countryOfOrigin: null, stock: 42000 },
  ...
  { name: 'Офсетная пластина UV СТР 490*370', sku: 'PLATE-UV-490x370', unit: 'шт', format: '490*370', category: 'Офсетные пластины', countryOfOrigin: null, stock: 1000 },
  { name: 'Офсетная пластина UV СТР 450*370', sku: 'PLATE-UV-450x370', unit: 'шт', format: '450*370', category: 'Офсетные пластины', countryOfOrigin: null, stock: 3000 },
  ...
  { name: 'Марзан 10*5*1380мм', sku: 'MARZ-138-10x5', unit: 'шт', format: '10*5*1380мм', category: 'Марзан', countryOfOrigin: null, stock: 351 },
  ...
  // ==================== ХИМИЯ И РАСХОДНИКИ ====================
  { name: 'Смывка для валов Turquoise 60 WM', sku: 'CHEM-WASH60', unit: 'литр', format: null, category: 'Химия и расходники', countryOfOrigin: null, stock: 2780 },
  { name: 'Добавка к увлажнению Alfa plus 3300', sku: 'CHEM-ALFA', unit: 'кг', format: null, category: 'Химия и расходники', countryOfOrigin: null, stock: 1250 },
  ...
  { name: 'Очиститель для пластин Novafix', sku: 'CHEM-NOVAFIX', unit: 'литр', format: 'Novafix', category: 'Химия и расходники', countryOfOrigin: null, stock: 2660 },
  { name: 'Нова плюс', sku: 'CHEM-NOVAPLUS', unit: 'литр', format: null, category: 'Химия и расходники', countryOfOrigin: null, stock: 1680 },

  // ==================== ВОДНО-ДИСПЕРСИОННЫЙ ЛАК ====================
  { name: 'Водно-дисперсионный лак глянцевый', sku: 'CHEM-VDL-GL', unit: 'кг', format: '30кг/20кг', category: 'Химия и расходники', countryOfOrigin: null, stock: 3390 },
  { name: 'Водно-дисперсионный лак матт', sku: 'CHEM-VDL-MT', unit: 'кг', format: '20кг', category: 'Химия и расходники', countryOfOrigin: null, stock: 780 },
  ...
  // ==================== ТЕРМОКЛЕЙ ====================
  { name: 'Термоклей в гранулах 6092', sku: 'GLUE-6092', unit: 'кг', format: '6092', category: 'Термоклей', countryOfOrigin: null, stock: 750 },
  { name: 'Термоклей в гранулах 6030', sku: 'GLUE-6030', unit: 'кг', format: '6030', category: 'Термоклей', countryOfOrigin: null, stock: 175 },
  { name: 'Термоклей в гранулах', sku: 'GLUE-GRAN', unit: 'кг', format: null, category: 'Термоклей', countryOfOrigin: null, stock: 1305 },

  // ==================== ПРОЧИЕ РАСХОДНИКИ ====================
  { name: 'Противоотмарывающий порошок Spray Powder', sku: 'CHEM-TALK', unit: 'кг', format: null, category: 'Химия и расходники', countryOfOrigin: null, stock: 474 },
  { name: 'Вискозная губка', sku: 'CHEM-GUBKA', unit: 'шт', format: null, category: 'Химия и расходники', countryOfOrigin: null, stock: 548 },
  { name: 'Пробойник 0.5', sku: 'MISC-PUNCH-05', unit: 'шт', format: '0.5', category: 'Расходники', countryOfOrigin: null, stock: 1118 },
  { name: 'Копировальная бумага А3', sku: 'MISC-COPY-A3', unit: 'пач', format: 'А3', category: 'Расходники', countryOfOrigin: null, stock: 34 },
  ...
  { name: 'Калибровочный картон 1000*1400 (0.3мм)', sku: 'KALIB-03', unit: 'шт', format: '0.3', category: 'Калибровочный картон', countryOfOrigin: null, stock: 662 },
  { name: 'Калибровочный картон 1000*1400 (0.4мм)', sku: 'KALIB-04', unit: 'шт', format: '0.4', category: 'Калибровочный картон', countryOfOrigin: null, stock: 476 },
  { name: 'Калибровочный картон 1000*1400 (0.5мм)', sku: 'KALIB-05', unit: 'шт', format: '0.5', category: 'Калибровочный картон', countryOfOrigin: null, stock: 260 },

  // ==================== КУРСОР И РИГЕЛЬ (ДЛЯ КАЛЕНДАРЕЙ) ====================
  { name: 'Курсор для календарей', sku: 'CURSOR', unit: 'шт', format: null, category: 'Расходники для календарей', countryOfOrigin: null, stock: 70905 },
  ...
  // ==================== ПАНТОННЫЕ КРАСКИ ====================
  { name: 'Пантон Opaque white', sku: 'PNT-OPAQ-WHITE', unit: 'кг', format: 'Opaque white', category: 'Пантонные краски', countryOfOrigin: null, stock: 60 },
  ...
  { name: 'Пантон Yellow', sku: 'PNT-YELLOW', unit: 'кг', format: 'Yellow', category: 'Пантонные краски', countryOfOrigin: null, stock: 41 },
  ...
  { name: 'Пантон Green', sku: 'PNT-GREEN', unit: 'кг', format: 'Green', category: 'Пантонные краски', countryOfOrigin: null, stock: 58 },
  { name: 'Пантон Silver 877', sku: 'PNT-SILVER877', unit: 'кг', format: 'Silver 877', category: 'Пантонные краски', countryOfOrigin: null, stock: 23 },
  { name: 'Пантон Gold 871', sku: 'PNT-GOLD871', unit: 'кг', format: 'Gold 871', category: 'Пантонные краски', countryOfOrigin: null, stock: 254 },
  { name: 'Пантон Gold 873', sku: 'PNT-GOLD873', unit: 'кг', format: 'Gold 873', category: 'Пантонные краски', countryOfOrigin: null, stock: 0 },
  { name: 'Пантон Gold 875', sku: 'PNT-GOLD875', unit: 'кг', format: 'Gold 875', category: 'Пантонные краски', countryOfOrigin: null, stock: 186 },
  ...
  { name: 'Проявитель Нова 1+9 UV', sku: 'CHEM-PROY-UV', unit: 'литр', format: 'Нова 1+9 UV', category: 'Химия и расходники', countryOfOrigin: null, stock: 170 },
  { name: 'Проявитель СТР (teknova)', sku: 'CHEM-PROY-CTP', unit: 'литр', format: 'СТР(teknova)', category: 'Химия и расходники', countryOfOrigin: null, stock: 2500 },
  { name: 'Проявитель для пластин (порошок, 200гр)', sku: 'CHEM-PROY-POWDER', unit: 'пач', format: null, category: 'Химия и расходники', countryOfOrigin: null, stock: 1084 },

  // ==================== БИГОВАЛЬНЫЙ КАНАЛ ====================
  { name: 'Биговальный канал 0,3*1,3', sku: 'BIG-03x13', unit: 'пач', format: '0,3*1,3', category: 'Биговальный канал', countryOfOrigin: null, stock: 472 },
  ...
  { name: 'Биговальный канал 0,4*1,4', sku: 'BIG-04x14', unit: 'пач', format: '0,4*1,4', category: 'Биговальный канал', countryOfOrigin: null, stock: 312 },
  { name: 'Биговальный канал 0,5*1,5', sku: 'BIG-05x15', unit: 'пач', format: '0,5*1,5', category: 'Биговальный канал', countryOfOrigin: null, stock: 324 },
  { name: 'Биговальный канал 0,4*1,3', sku: 'BIG-04x13', unit: 'пач', format: '0,4*1,3', category: 'Биговальный канал', countryOfOrigin: null, stock: 203 },
  { name: 'Биговальный канал 0,7*2,3', sku: 'BIG-07x23', unit: 'пач', format: '0,7*2,3', category: 'Биговальный канал', countryOfOrigin: null, stock: 496 },
  { name: 'Биговальный канал 0,8*2,5', sku: 'BIG-08x25', unit: 'пач', format: '0,8*2,5', category: 'Биговальный канал', countryOfOrigin: null, stock: 41 },

  // ==================== ОФСЕТНОЕ ПОЛОТНО (РЕЗИНА) ====================
  { name: 'Офсетное полотно 520*440', sku: 'RUBBER-520x440', unit: 'шт', format: '520*440', category: 'Офсетная резина', countryOfOrigin: null, stock: 161 },
  ...
  { name: 'Офсетное полотно 1052*840', sku: 'RUBBER-1052x840', unit: 'шт', format: '1052*840', category: 'Офсетная резина', countryOfOrigin: null, stock: 145 },
  ...
  { name: 'Офсетное полотно рулонное 1060мм', sku: 'RUBBER-RUL-106', unit: 'м', format: '106', category: 'Офсетная резина', countryOfOrigin: null, stock: 119.94 },
  ...
  { name: 'Металлическая гребёнка 3/8 (9,5мм) белая', sku: 'GREB-3-8-W', unit: 'бабина', format: '3*8(ок)', category: 'Расходники для календарей', countryOfOrigin: null, stock: 140 },
  ...
  { name: 'Металлическая гребёнка 5/16 (7,9мм) чёрная', sku: 'GREB-5-16-B', unit: 'бабина', format: '5*16(кора)', category: 'Расходники для календарей', countryOfOrigin: null, stock: 12 },
  { name: 'Металлическая гребёнка 1/2 (12,7мм)', sku: 'GREB-1-2', unit: 'бабина', format: '1*2(ок)', category: 'Расходники для календарей', countryOfOrigin: null, stock: 16 },
...
async function main() {
  console.log(`\n=== Stock Import (остаток 02.02.2026) ===`);
